...
class OpenInventory extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("aloeAfterSunCream", "/assets/shopItems/aloeAfterSunCream.png");
  ...
  create() {
    ...
    // Tabs
    const invTab = this.add.text(width / 2 - 100, height / 2 - 250, "Inventory", {
    ...
    const craftTab = this.add.text(width / 2 + 100, height / 2 - 250, "Crafting", {
