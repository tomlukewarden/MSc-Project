...
function GameCanvas() {
    ...
    useEffect(() => {
        ...
        const config = {
            ...
            scene: [Menu, MapScene, StartScene, ShopScene, WeeCairScene, GreenhouseScene, WallGardenScene, ShardGardenScene, MiddleGardenScene, HUDScene, OpenJournal, OpenInventory, OpenSettings, chestUI, MiniGameScene],
        };
